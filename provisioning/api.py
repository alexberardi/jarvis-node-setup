...
def _save_node_credentials(node_id: str, node_key: str) -> bool:
    ...
    Will NOT overwrite an existing config that already has valid credentials
    (a real node_id that isn't a placeholder). This prevents accidental
    overwrites during tests or re-provisioning.
