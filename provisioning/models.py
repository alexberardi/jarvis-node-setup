...
class ProvisionRequest(BaseModel):
    ...
    command_center_url: str = Field(..., description="URL of the command center (e.g., http://192.168.1.50:7703)")
    config_service_url: Optional[str] = Field(default=None, description="URL of the config service (e.g., http://192.168.1.50:7700)")
